...
def create_qa_model():
    index_path = "S:/Projects/Medibot/faiss_index/index.faiss"
    texts_path = "S:/Projects/Medibot/faiss_index/texts.pkl"
    ...
    if os.path.exists(index_path) and os.path.exists(texts_path):
        ...
        extracted_data = load_pdf("S:/Projects/Medibot/Data")
    ...
    llm = CTransformers(
        model="S:/Projects/Medibot/Model/llama-2-7b-chat.ggmlv3.q4_0.bin",
        model_type="llama",
...
def ask():
    ...
    try:
        ...
        logging.error("Error during model invocation", exc_info=True)
